...
# PROJECT: SANA-map
# FILE: nn_utils.py
# DESCRIPTION: The two small building blocks Semantic_Mapping needs to
#              warp the egocentric map into the geocentric frame
#              (get_grid) and collapse per-category masks over the
#              vertical axis (ChannelPool).
# ═══════════════════════════════════════════════════════════════════════
